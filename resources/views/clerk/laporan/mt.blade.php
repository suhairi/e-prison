	...
	<div class="row">
		<div class="col-md-10 col-md-offset-1">
			<div class="panel panel-default">
				...
				<table width="70%" border="0" style="border : solid 1px #000">
				    <tr>
                    ...
                    <tr>
                        ...
                        <td style="cellpadding='2'">Pegawai Pusat Kehadiran Wajib  Daerah Baling / Sik Kedah</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td valign="top"><strong>:</strong></td>
                        <td style="cellpadding='2'">Pengarah Parol Dan Perkhidmatan Komuniti Negeri Kedah</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td valign="top"><strong>:</strong></td>
                        <td style="cellpadding='2'">{{ $cases->memoTerima }}</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td valign="top"><strong>:</strong></td>
                        <td style="cellpadding='2'">{{ $cases->tarikhMasuk }}</td>
                    </tr>
