...
class PrefixController extends Controller {
    ...
    public function getNoCase() {
        return view('admin/tetapan/prefix/noKes');
    }
    ...
    public function getMemoTerima() {
        ...
        return view('admin/tetapan/prefix/memoTerima')
    ...
    public function postMemoTerima() {
        ...
        if($validation->fails()) {
            return redirect('admin/prefix/prefix-memo-terima')
                ->withInput()
    ...
    public function getMemoPolis() {
        ...
        return view('admin/tetapan/prefix/memoPolis')
            ->with('prefixes', $prefixes);
    }
    ...
    public function postMemoPolis() {
        ...
        if($validation->fails()) {
            return redirect('admin/prefix/prefix-memo-polis')
                ->withInput()
                ->withErrors($validation->errors());
        }
...
//        dd($request);
    ...
    public function getMemoSelesai() {
        ...
        return view('admin/tetapan/prefix/memoSelesai')
            ->with('prefixes', $prefixes);
    }
    ...
    public function postMemoSelesai() {
        ...
        if($validation->fails()){
            return redirect('admin/tetapan/prefix/memoSelesai')
                ->withInput()
                ->withErrors($validation->errors());
        }
